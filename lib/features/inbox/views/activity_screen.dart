...
import 'package:tiktok_clone/features/inbox/widgets/activity_drop_down_panel.dart';
import 'package:tiktok_clone/features/inbox/widgets/activity_tile.dart';
      ...
      body: Stack(
        children: [
          ...
          SlideTransition(
            ...
            child: const ActivityDropDownPanel(),
          ),
        ],
      ),
    );
